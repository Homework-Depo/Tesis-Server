...
-- CreateIndex
CREATE UNIQUE INDEX "_MatterUser_AB_unique" ON "_MatterUser"("A", "B");

-- CreateIndex
CREATE INDEX "_MatterUser_B_index" ON "_MatterUser"("B");
...
-- AddForeignKey
ALTER TABLE "_MatterUser" ADD CONSTRAINT "_MatterUser_A_fkey" FOREIGN KEY ("A") REFERENCES "Matter"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MatterUser" ADD CONSTRAINT "_MatterUser_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
